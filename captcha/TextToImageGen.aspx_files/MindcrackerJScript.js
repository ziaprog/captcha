...
function HideShowOne(check)
{
	if(document.getElementById("ctl00_ContentPlaceHolder1_FeaturedArticle1_onlyOneRow") != null)
	{
		...
		{
			document.getElementById("ctl00_ContentPlaceHolder1_FeaturedArticle1_onlyOneRow").innerHTML = document.getElementById("ctl00_ContentPlaceHolder1_HomeCenter1_FeaturedArticle1_hide"+check).value;
		}
	}
}
