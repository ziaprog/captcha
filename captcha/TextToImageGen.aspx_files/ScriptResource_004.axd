...
var element = this.get_element();if (!element) return;var x = 0;var y = 0;if (this._animate) {
if (document.documentElement && document.documentElement.scrollTop) {
x = document.documentElement.scrollLeft;y = document.documentElement.scrollTop;} else {
x = document.body.scrollLeft;y = document.body.scrollTop;}
}
var clientBounds = CommonToolkitScripts.getClientBounds();var width = clientBounds.width;var height = clientBounds.height;switch (this._horizontalSide) {
